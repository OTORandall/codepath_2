...
// if we didn't catch the id var then we just back to index page
if(!isset($_GET['id'])) {
  redirect_to('index.php');
}
$id = $_GET['id'];
// find the salesperson we want in the database
...
<div id="main-content">
  ...
  ?>
  <br />
  <a href="./edit.php?id=<?php echo u(h($salesperson['id'])); ?>">Edit</a><br />
</div>
